@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between mb-8">
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between flex-col gap-3">
            ...
            <div>
                <span class="relative z-0 inline-flex rtl:flex-row-reverse shadow-sm rounded-md w-full">
                    {{-- Previous Page Link --}}
                    @if ($paginator->onFirstPage())
